...
const SIZES = {
  sm: { fontSize: "0.6875rem", padding: "0.1875rem 0.5rem", gap: "0.25rem" },
  md: { fontSize: "0.75rem", padding: "0.25rem 0.75rem", gap: "0.375rem" },
  lg: { fontSize: "0.875rem", padding: "0.375rem 1rem", gap: "0.5rem" },
};
...
export function RiskBadge({ level, size = "md", showIcon = true }: RiskBadgeProps) {
  ...
  return (
    ...
    >
      {showIcon && ICONS[normalizedLevel]}
      {config.label}
    </span>
  );
}
